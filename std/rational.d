...
struct Rational(T) if(isSignedIntegral!T)
{
  ...
  @property T num() @safe pure nothrow const
  {
    return this.numerator;
  }

  /// Returns the denominator of the rational number.
  @property T den() @safe pure nothrow const
  {
  ...
  static if(mutableT)
  {
    ...
    */
    ...
    /**
       Returns the denominator of the rational number.  The rational number is
       simplified if it is not already in simplified form.  This method is
       available only if the numerator and the denominator are both mutable.
     */
    @property T den() @safe pure
    {
      if(dirty)
        this = Rational(this.numerator, this.denominator);
      return this.denominator;
...
@safe pure:
  ...
  @property F value(F = double)() const nothrow if(isFloatingPoint!F)
  {
    return to!F(this.num) / to!F(this.den);
  }
 
  // rational == rational
  bool opEquals(G)(Rational!G other) const
  {
  ...
  // rational == integral
  bool opEquals(G)(G i) const if(isSignedIntegral!G)
  {
    return this.num == i && this.den == 1;
  }

  // rational cmp rational
  int opCmp(G)(Rational!G other) const
  {
  ...
  int opCmp(G)(G i) const if(isSignedIntegral!G)
  {
    return this.opCmp(Rational(i));
  }

  // -rational
  Rational opUnary(string op)() const if(op == "-")
  {
    return Rational(-this.num, this.den);
  }

  // rational + rational, rational - rational
  Rational!(CommonType!(T,G)) opBinary(string op, G)(Rational!G other) const
  if(op == "+" || op == "-")
  {
  ...
  Rational!(CommonType!(T,G)) opBinary(string op, G)(G i) const
  if((op == "+" || op == "-") && isSignedIntegral!G)
  {
    alias typeof(return) R;
  ...
  Rational!(CommonType!(T,G)) opBinaryRight(string op, G)(G i) const
  if((op == "+" || op == "*") && isSignedIntegral!G)
  {
  ...
  ref Rational opOpAssign(string op, G)(Rational!G other)
  {
    this = this.opBinary!(op, G)(other);
    return this;
  }

  ref Rational opOpAssign(string op, G)(G i) if(isSignedIntegral!G)
  {
...
/**
   ...
   ---
*/
G ceil(G)(Rational!G r) @safe pure
{
  if(r.den == 1)
    return r.num;
...
/**
   ...
   ---
*/
G floor(G)(Rational!G r) @safe pure
{
  if(r.den == 1)
    return r.num;
...
/**
   ...
   ---
*/
G round(G)(Rational!G r) @safe pure
{
  if(r.den == 1)
    return r.num;
